...
const Projects = () => {
  return (
    <section className="text-gray-600 body-font">
      <div className="px-4  md:px-8 xl:px-4 py-5 max-w-[1400px] mx-auto text-center  md:pt-5 md:mt-5 ">
        <div
          id="projects"
        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-y-12 sm:gap-x-3 md:gap-x-5 lg:gap-x-2 lg:gap-y-5 xl:gap-y-10 xl:gap-x-5 mt-4 md:mt-8 ">
          {ProjectsData.map((project) => (
            ...
            >
              ...
              />
              <div className="absolute flex flex-col justify-center cursor-pointer items-center bottom-0 left-0 right-0 h-0 overflow-hidden group-hover:h-full transition-[height_0.5s] duration-500 bg-darkblue rounded-xl">
