...
const Profile = () => {
  return (
    ...
    >
      {/* ✅ Apply max width and spacing to this wrapper */}
      <div className="w-full max-w-[1400px] px-4 md:px-8 xl:px-4 py-5 mx-auto">
        <div className="gap-2 flex flex-col md:pt-12 lg:py-20 md:px-7 lg:flex-row-reverse items-center min-h-fit">
          {/* Profile Image */}
          <motion.div
